pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.164.241.185/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Deepu12363/fullstackapp.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.164.241.185/springapp1"
            echo "✅ Frontend deployed: http://54.164.241.185/frontapp1"
        }
        failure {
